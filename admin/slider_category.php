    ...
    <div class="box4"> 
        <form action="" method="post" enctype="multipart/form-data">
            <table class="form-tb">
                ...
                <tr>
                    <td>Slider Name:</td><td><input type="text" name="slider_name" placeholder="Slider Name"></td>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($slider_name) or empty($image)) {
                        ...
                        if ($number > 0) {
                            ...
                            $insert = mysql_query("INSERT INTO slider (slider_id,image,title_name) VALUES ('','$image','$slider_name')");
                            if ($insert) {
                                echo "<font color='green'>Slider Inserting Successfull</font>";
                            } else {
                                echo"<font color='red'>Slider Inserting is Not Sending </font>";
                            }
                        }
                    }
                }
