...
<body style="background:#fff;">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider2.$ScaleWidth(Math.min(parentWidth, 1100));
                else
    ...
    <div id="slider2_container" style="position: relative; width: 1100px;
        height: 300px;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: -20px; width: 1100px; height: 320px;
            overflow: hidden;">
             <?php 
                ...
                ?>
            <div>
                <a u=image href="#"><img src="admin/<?php echo $fetch['image'];?>" /></a>
            </div>
            <?php } ?>
        </div>
